 ...
 */
inline fun <T> Observable<Query>.mapToOne(noinline mapper: (Cursor) -> T): Observable<T>
 ...
 */
inline fun <T> Observable<Query>.mapToOneOrDefault(default: T, noinline mapper: (Cursor) -> T): Observable<T>
 ...
 */
@RequiresApi(24)
inline fun <T> Observable<Query>.mapToOptional(noinline mapper: (Cursor) -> T): Observable<Optional<T>>
 ...
 * @param mapper Maps the current [Cursor] row to `T`. May not return null.
 */
inline fun <T> Observable<Query>.mapToList(noinline mapper: (Cursor) -> T): Observable<List<T>>
